...
<span class="token keyword">class</span> <span class="token class-name">_CalendarDatetimePickerPageState</span>
            ...
            <span class="token function">DemoBlock</span><span class="token punctuation">(</span>
              ...
              <span class="token literal-property property">child</span><span class="token operator">:</span> <span class="token function">AntButton</span><span class="token punctuation">(</span>
                  ...
                  <span class="token literal-property property">onPressed</span><span class="token operator">:</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
                    <span class="token function">showAntCalendarDatetimePicker</span><span class="token punctuation">(</span>
                        ...
                        <span class="token literal-property property">onOk</span><span class="token operator">:</span> <span class="token punctuation">(</span>date<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><div class="triones-code-preview"><iframe src="/triones-antd-mobile-flutter/web/index.html#/calendar-datetime-picker"></iframe></div></div><h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-label="Permalink to &quot;API&quot;">​</a></h2><table tabindex="0"><thead><tr><th>属性</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>value</td><td>当前值</td><td><code>DateTime? </code></td><td>DateTime.now()</td></tr><tr><td>onOk</td><td>确定按钮回调</td><td><code>ValueChanged&lt;DateTime?&gt;? </code></td><td></td></tr></tbody></table>`,5)]))}const m=a(e,[["render",o]]);export{d as __pageData,m as default};
